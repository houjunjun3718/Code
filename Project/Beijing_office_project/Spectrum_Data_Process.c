...
int Spectrum_Data_Process(char *data,PUP *element)
{
    ...
    int add = 0;
    /*Retriever电量*/
    sprintf(element->P0,"%s;stat;900;%s;%ld",ret[2],ret[3],ti);
    add++;

    /*PUP的信号强度*/
    sprintf(element->P1,"%s;stat;901;%s;%ld",ret[4],ret[5],ti);
    add++;

    /*PUP的电量*/
    sprintf(element->P2,"%s;stat;900;%s;%ld",ret[4],ret[6],ti);
    add++;
    int type = 0;
    ...
    if('A' == ret[9][0] || 'B' == ret[9][0] || 'B' == ret[9][0] || 'D' == ret[9][0])
    {
        ...
        sprintf(element->P3,"%s%s;data;%d;%s;%ld",ret[4],ret[9],type,ret[13],ti);
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[14][0] || 'B' == ret[14][0] || 'B' == ret[14][0] || 'D' == ret[14][0])
    {
        ...
        sprintf(element->P4,"%s%s;data;%d;%s;%ld",ret[4],ret[14],type,ret[18],ti);
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[19][0] || 'B' == ret[19][0] || 'B' == ret[19][0] || 'D' == ret[19][0])
    {
        ...
        sprintf(element->P5,"%s%s;data;%d;%s;%ld",ret[4],ret[19],type,ret[23],ti);
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[24][0] || 'B' == ret[24][0] || 'B' == ret[24][0] || 'D' == ret[24][0])
    {
        ...
        sprintf(element->P6,"%s%s;data;%d;%s;%ld",ret[4],ret[24],type,ret[28],ti);
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[29][0] || 'B' == ret[29][0] || 'B' == ret[29][0] || 'D' == ret[29][0])
    {
        ...
        sprintf(element->P7,"%s%s;data;%d;%s;%ld",ret[4],ret[29],type,ret[33],ti);
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[34][0] || 'B' == ret[34][0] || 'B' == ret[34][0] || 'D' == ret[34][0])
    {
        ...
        sprintf(element->P8,"%s%s;data;%d;%s;%ld",ret[4],ret[34],type,ret[38],ti);
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[39][0] || 'B' == ret[39][0] || 'B' == ret[39][0] || 'D' == ret[9][0])
    {
        ...
        sprintf(element->P9,"%s%s;data;%d;%s;%ld",ret[4],ret[39],type,ret[43],ti);
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[44][0] || 'B' == ret[44][0] || 'B' == ret[44][0] || 'D' == ret[44][0])
    {
        ...
        sprintf(element->PA,"%s%s;data;%d;%s;%ld",ret[4],ret[44],type,ret[48],ti); 
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[49][0] || 'B' == ret[49][0] || 'B' == ret[49][0] || 'D' == ret[49][0])
    {
        ...
        sprintf(element->PB,"%s%s;data;%d;%s;%ld",ret[4],ret[49],type,ret[53],ti);   
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[54][0] || 'B' == ret[54][0] || 'B' == ret[54][0] || 'D' == ret[54][0])
    {
        ...
        sprintf(element->PC,"%s%s;data;%d;%s;%ld",ret[4],ret[54],type,ret[58],ti);  
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[59][0] || 'B' == ret[59][0] || 'B' == ret[59][0] || 'D' == ret[59][0])
    {
        ...
        sprintf(element->PD,"%s%s;data;%d;%s;%ld",ret[4],ret[59],type,ret[63],ti);       
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[64][0] || 'B' == ret[64][0] || 'B' == ret[64][0] || 'D' == ret[64][0])
    {
        ...
        sprintf(element->PE,"%s%s;data;%d;%s;%ld",ret[4],ret[64],type,ret[68],ti);   
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
    ...
    if('A' == ret[69][0] || 'B' == ret[69][0] || 'B' == ret[69][0] || 'D' == ret[69][0])
    {
        ...
        sprintf(element->PF,"%s%s;data;%d;%s;%ld",ret[4],ret[69],type,ret[73],ti);        
        add++;
    }else{
        WriteLog("数据处理完成!");
        return add;
